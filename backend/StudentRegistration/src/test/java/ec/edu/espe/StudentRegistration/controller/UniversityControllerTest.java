...
class UniversityControllerTest {
    ...
    public void testGetUniversity_ValidId() {
        ...
        ResponseEntity<UniversityDTO> response = universityController.getUniversity(universityId);
    ...
    public void testGetAllUniversities() {
        ...
        List<UniversityDTO> universities = universityController.getAllUniversities();
    ...
    public void testSaveUniversity_ValidUniversity() {
        ...
        ResponseEntity<UniversityDTO> response = universityController.saveUniversity(universityToSave);
    ...
    public void testPutUniversity_ValidUniversity() {
        ...
        ResponseEntity<UniversityDTO> response = universityController.putUniversity(universityId, universityToUpdate);
        assertEquals(HttpStatus.OK, response.getStatusCode());
