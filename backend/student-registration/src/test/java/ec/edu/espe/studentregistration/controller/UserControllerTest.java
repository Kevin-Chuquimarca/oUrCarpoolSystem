...
class UserControllerTest {
    ...
    void postUser_ReturnsCreatedUser() {
        ...
        ResponseEntity<UserDTO> response = userController.post(userDTO);
    ...
    void putUser_ReturnsUpdatedUser() {
        ...
        ResponseEntity<UserDTO> response = userController.putById(userId, userDTO);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals(userDTO, response.getBody());
    }
    ...
    void deleteUser_CallsDeleteById() {
        Integer userId = 1;
        assertDoesNotThrow(() -> userController.deleteById(userId));
    ...
    void putUserPassword_ReturnsMessageResponseDTOWhenPasswordChanged() {
        ...
        ResponseEntity<MessageResponseDTO> response = userController.putPassword(userId, new UserLoginDTO("test@email.com", "password"));
        assertEquals(HttpStatus.OK, response.getStatusCode());
