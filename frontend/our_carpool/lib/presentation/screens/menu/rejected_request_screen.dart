...
import '../../../domain/driver_approval/driver_request_domain.dart';
import '../../../utils/colors.dart';

class RejectedRequestScreen extends StatefulWidget {
  const RejectedRequestScreen({Key? key}) : super(key: key);

  @override
  State<RejectedRequestScreen> createState() => _RejectedRequestScreenState();
}

class _RejectedRequestScreenState extends State<RejectedRequestScreen> {
  List<DriverRequest> _driversRequests = List.empty();

  _getDriversRequests() {
    DriverRequestDomain driverRequestDomain = DriverRequestDomain();
    driverRequestDomain.getAllRejected().then((value) {
      setState(() {
